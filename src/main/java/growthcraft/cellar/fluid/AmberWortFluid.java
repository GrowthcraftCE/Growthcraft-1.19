...
public class AmberWortFluid extends ForgeFlowingFluid {
    ...
    private static final RegistryObject<LiquidBlock> block = GrowthcraftCellarFluids.AMBER_WORT_FLUID_BLOCK;
    private static final ColorUtils.GrowthcraftColor color = AMBER_WORT_FLUID_COLOR;
    private static final RegistryObject<GrowthcraftBucketItem> registry_bucket = GrowthcraftCellarItems.BUCKET_AMBER_WORT;
