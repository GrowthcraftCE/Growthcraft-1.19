...
public class DarkWortFluid extends ForgeFlowingFluid {
    ...
    private static final RegistryObject<LiquidBlock> block = GrowthcraftCellarFluids.DARK_WORT_FLUID_BLOCK;
    private static final ColorUtils.GrowthcraftColor color = DARK_WORT_FLUID_COLOR;
    private static final RegistryObject<GrowthcraftBucketItem> registry_bucket = GrowthcraftCellarItems.BUCKET_DARK_WORT;
