...
public class CopperLagerFluid extends ForgeFlowingFluid {
    ...
    private static final RegistryObject<LiquidBlock> block = GrowthcraftCellarFluids.COPPER_LAGER_FLUID_BLOCK;
    private static final ColorUtils.GrowthcraftColor color = COPPER_LAGER_FLUID_COLOR;
    private static final RegistryObject<GrowthcraftBucketItem> registry_bucket = GrowthcraftCellarItems.BUCKET_COPPER_LAGER;
