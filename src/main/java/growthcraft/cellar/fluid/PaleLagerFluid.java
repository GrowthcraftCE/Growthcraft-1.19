...
public class PaleLagerFluid extends ForgeFlowingFluid {
    ...
    private static final RegistryObject<LiquidBlock> block = GrowthcraftCellarFluids.PALE_LAGER_FLUID_BLOCK;
    private static final ColorUtils.GrowthcraftColor color = PALE_LAGER_FLUID_COLOR;
    private static final RegistryObject<GrowthcraftBucketItem> registry_bucket = GrowthcraftCellarItems.BUCKET_PALE_LAGER;
