...
import static growthcraft.cellar.shared.Reference.FluidColor.COPPER_WORT_FLUID_COLOR;

public class CopperWortFluid extends ForgeFlowingFluid {
    ...
    private static final RegistryObject<LiquidBlock> block = GrowthcraftCellarFluids.COPPER_WORT_FLUID_BLOCK;
    private static final ColorUtils.GrowthcraftColor color = COPPER_WORT_FLUID_COLOR;
    private static final RegistryObject<GrowthcraftBucketItem> registry_bucket = GrowthcraftCellarItems.BUCKET_COPPER_WORT;
