...
public class DarkLagerFluid extends ForgeFlowingFluid {
    ...
    private static final RegistryObject<LiquidBlock> block = GrowthcraftCellarFluids.DARK_LAGER_FLUID_BLOCK;
    private static final ColorUtils.GrowthcraftColor color = DARK_LAGER_FLUID_COLOR;
    private static final RegistryObject<GrowthcraftBucketItem> registry_bucket = GrowthcraftCellarItems.BUCKET_DARK_LAGER;
