...
public class IpaAleFluid extends ForgeFlowingFluid {
    ...
    private static final RegistryObject<LiquidBlock> block = GrowthcraftCellarFluids.IPA_ALE_FLUID_BLOCK;
    private static final ColorUtils.GrowthcraftColor color = IPA_ALE_FLUID_COLOR;
    private static final RegistryObject<GrowthcraftBucketItem> registry_bucket = GrowthcraftCellarItems.BUCKET_IPA_ALE;
