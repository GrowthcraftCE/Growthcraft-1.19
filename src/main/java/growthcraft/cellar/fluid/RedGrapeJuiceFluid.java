...
import static growthcraft.cellar.shared.Reference.FluidColor.RED_GRAPE_JUICE;

public class RedGrapeJuiceFluid extends ForgeFlowingFluid {
    ...
    private static final RegistryObject<LiquidBlock> block = GrowthcraftCellarFluids.RED_GRAPE_JUICE_FLUID_BLOCK;
    private static final ColorUtils.GrowthcraftColor color = RED_GRAPE_JUICE;
    private static final RegistryObject<GrowthcraftBucketItem> registry_bucket = GrowthcraftCellarItems.BUCKET_RED_GRAPE_JUICE;
