...
public class CopperAleFluid extends ForgeFlowingFluid {
    ...
    private static final RegistryObject<LiquidBlock> block = GrowthcraftCellarFluids.COPPER_ALE_FLUID_BLOCK;
    private static final ColorUtils.GrowthcraftColor color = COPPER_ALE_FLUID_COLOR;
    private static final RegistryObject<GrowthcraftBucketItem> registry_bucket = GrowthcraftCellarItems.BUCKET_COPPER_ALE;
