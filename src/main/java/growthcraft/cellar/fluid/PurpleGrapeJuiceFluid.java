...
import static growthcraft.cellar.shared.Reference.FluidColor.PURPLE_GRAPE_JUICE;

public class PurpleGrapeJuiceFluid extends ForgeFlowingFluid {
    ...
    private static final RegistryObject<LiquidBlock> block = GrowthcraftCellarFluids.PURPLE_GRAPE_JUICE_FLUID_BLOCK;
    private static final ColorUtils.GrowthcraftColor color = PURPLE_GRAPE_JUICE;
