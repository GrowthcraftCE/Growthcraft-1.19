...
public class GoldenWort extends ForgeFlowingFluid {

    private static final RegistryObject<GoldenWort.Flowing> REGISTRY_FLUID_FLOWING = GrowthcraftCellarFluids.GOLDEN_WORT_FLUID_FLOWING;
    private static final RegistryObject<GoldenWort.Source> REGISTRY_FLUID_STILL = GrowthcraftCellarFluids.GOLDEN_WORT_FLUID_STILL;
    private static final RegistryObject<LiquidBlock> block = GrowthcraftCellarFluids.GOLDEN_WORT_FLUID_BLOCK;
    private static final ColorUtils.GrowthcraftColor color = GOLDEN_WORT_FLUID_COLOR;
    private static final RegistryObject<GrowthcraftBucketItem> registry_bucket = GrowthcraftCellarItems.BUCKET_GOLDEN_WORT;
    ...
    protected GoldenWort(Properties properties) {
        super(properties);
    }
    ...
    public static class Flowing extends GoldenWort {
        public Flowing() {
    ...
    public static class Source extends GoldenWort {
        public Source() {
            super(FLUID_PROPERTIES);
        }
