package growthcraft.cellar.lib.turtywurty.registry;
...
public class FluidRegistryContainer {
    ...
    public FluidRegistryContainer(String name, FluidType.Properties typeProperties,
        ...
        this.source = GrowthcraftCellarFluids.FLUIDS.register(name + "_source", () -> new ForgeFlowingFluid.Source(this.properties));
        this.flowing = GrowthcraftCellarFluids.FLUIDS.register(name + "_flowing",
        ...
        this.block = GrowthcraftCellarBlocks.BLOCKS.register(name, () -> new LiquidBlock(this.source, blockProperties));
        this.properties.block(this.block);

        this.bucket = GrowthcraftCellarItems.ITEMS.register(name + "_bucket", () -> new BucketItem(this.source, itemProperties));
