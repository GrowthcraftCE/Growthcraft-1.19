package growthcraft.apiary.lib.turtywurty.registry;
...
public class FluidRegistryContainer {
    ...
    public FluidRegistryContainer(String name, FluidType.Properties typeProperties,
        ...
        this.type = GrowthcraftApiaryFluids.FLUID_TYPES.register(name, () -> new FluidType(this.typeProperties) {
            @Override
        ...
        this.source = GrowthcraftApiaryFluids.FLUIDS.register(name + "_source", () -> new ForgeFlowingFluid.Source(this.properties));
        this.flowing = GrowthcraftApiaryFluids.FLUIDS.register(name + "_flowing",
        ...
        this.block = GrowthcraftApiaryBlocks.BLOCKS.register(name, () -> new LiquidBlock(this.source, blockProperties));
        this.properties.block(this.block);

        this.bucket = GrowthcraftApiaryItems.ITEMS.register(name + "_bucket", () -> new BucketItem(this.source, itemProperties));
