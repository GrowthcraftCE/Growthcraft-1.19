...
public class WaxGrayFluid extends ForgeFlowingFluid {
    private static final RegistryObject<Flowing> REGISTRY_FLUID_FLOWING = GrowthcraftApiaryFluids.WAX_GRAY_FLUID_FLOWING;
    private static final RegistryObject<Source> REGISTRY_FLUID_STILL = GrowthcraftApiaryFluids.WAX_GRAY_FLUID_STILL;
    private static final RegistryObject<LiquidBlock> block = GrowthcraftApiaryFluids.WAX_GRAY_FLUID_BLOCK;
