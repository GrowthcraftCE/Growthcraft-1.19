...
import static growthcraft.apiary.shared.Reference.FluidColor.HONEY_FLUID_COLOR;

public class HoneyFluid extends ForgeFlowingFluid {
    private static final RegistryObject<Flowing> REGISTRY_FLUID_FLOWING = GrowthcraftApiaryFluids.HONEY_FLUID_FLOWING;
    private static final RegistryObject<Source> REGISTRY_FLUID_STILL = GrowthcraftApiaryFluids.HONEY_FLUID_STILL;
    private static final RegistryObject<LiquidBlock> block = GrowthcraftApiaryFluids.HONEY_FLUID_BLOCK;
    private static final ColorUtils.GrowthcraftColor color = HONEY_FLUID_COLOR;
    private static final RegistryObject<GrowthcraftBucketItem> registry_bucket = GrowthcraftApiaryItems.BUCKET_HONEY;
