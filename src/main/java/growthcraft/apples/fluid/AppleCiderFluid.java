...
public class AppleCiderFluid extends ForgeFlowingFluid {
    private static final RegistryObject<Flowing> REGISTRY_FLUID_FLOWING = GrowthcraftApplesFluids.APPLE_CIDER_FLUID_FLOWING;
    private static final RegistryObject<Source> REGISTRY_FLUID_STILL = GrowthcraftApplesFluids.APPLE_CIDER_FLUID_STILL;
    private static final RegistryObject<LiquidBlock> block = GrowthcraftApplesFluids.APPLE_CIDER_FLUID_BLOCK;
    private static final ColorUtils.GrowthcraftColor color = APPLE_CIDER_FLUID_COLOR;
    private static final RegistryObject<GrowthcraftBucketItem> registry_bucket = GrowthcraftApplesItems.BUCKET_APPLE_CIDER;
    ...
    protected AppleCiderFluid(Properties properties) {
        super(properties);
    }
