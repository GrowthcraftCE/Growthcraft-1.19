package growthcraft.apples.lib.turtywurty.registry;
...
public class FluidRegistryContainer {
    ...
    public FluidRegistryContainer(String name, FluidType.Properties typeProperties,
        ...
        this.type = GrowthcraftApplesFluids.FLUID_TYPES.register(name, () -> new FluidType(this.typeProperties) {
            @Override
        ...
        this.source = GrowthcraftApplesFluids.FLUIDS.register(name + "_source", () -> new ForgeFlowingFluid.Source(this.properties));
        this.flowing = GrowthcraftApplesFluids.FLUIDS.register(name + "_flowing",
        ...
        this.block = GrowthcraftApplesBlocks.BLOCKS.register(name, () -> new LiquidBlock(this.source, blockProperties));
        this.properties.block(this.block);

        this.bucket = GrowthcraftApplesItems.ITEMS.register(name + "_bucket", () -> new BucketItem(this.source, itemProperties));
