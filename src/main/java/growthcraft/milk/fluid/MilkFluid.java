...
public class MilkFluid extends ForgeFlowingFluid {
    ...
    private static final RegistryObject<MilkFluid.Flowing> REGISTRY_FLUID_FLOWING = GrowthcraftMilkFluids.MILK_FLUID_FLOWING;
    private static final RegistryObject<MilkFluid.Source> REGISTRY_FLUID_STILL = GrowthcraftMilkFluids.MILK_FLUID_STILL;
    private static final RegistryObject<LiquidBlock> block = GrowthcraftMilkFluids.MILK_FLUID_BLOCK;
