package growthcraft.milk.lib.turtywurty.registry;
...
public class FluidRegistryContainer {
    ...
    public FluidRegistryContainer(String name, FluidType.Properties typeProperties,
        ...
        this.type = GrowthcraftMilkFluids.FLUID_TYPES.register(name, () -> new FluidType(this.typeProperties) {
            @Override
        ...
        this.source = GrowthcraftMilkFluids.FLUIDS.register(name + "_source", () -> new ForgeFlowingFluid.Source(this.properties));
        this.flowing = GrowthcraftMilkFluids.FLUIDS.register(name + "_flowing",
        ...
        this.block = GrowthcraftMilkBlocks.BLOCKS.register(name, () -> new LiquidBlock(this.source, blockProperties));
        this.properties.block(this.block);

        this.bucket = GrowthcraftMilkItems.ITEMS.register(name + "_bucket", () -> new BucketItem(this.source, itemProperties));
